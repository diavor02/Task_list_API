...
<h2>Overview</h2>
<p>This is the architecture of Tasks API, a RESTful API for managing user tasks with JWT authentication, built using FastAPI and PostgreSQL, deployed as an AWS Lambda function with API Gateway.</p>
