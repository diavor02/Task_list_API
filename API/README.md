...
<br>
<p>Note: for more information, access FastApi's automatically created documentation at "[https://4mvvs3klti.execute-api.us-east-1.amazonaws.com/docs](https://x1y5tdqmai.execute-api.us-east-1.amazonaws.com/docs)"</p>
